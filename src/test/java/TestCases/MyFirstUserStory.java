...
public class MyFirstUserStory {
	...
	driver.findElement(By.xpath("//input[@id='searchInput']")).click();
		...
		//driver.findElement(ByXPath("//input[@id='searchInput']")).click();
		
		Thread.sleep(2000);
		driver.findElement(By.xpath("//input[@id='searchInput']")).sendKeys("Adani");
		System.out.println("Step 2 done");
		Select drpCountry = new Select(driver.findElement(By.className("lang-list-button-text jsl10n")));
		drpCountry.selectByVisibleText("Polksi");
		
		driver.findElement(By.xpath("//span[@data-jsl10n='portal.language-button-text']")).click();
